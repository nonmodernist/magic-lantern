...
class LanternResearchToolV3 {
    constructor() {
        ...
        this.sourceRankings = {
            high: [
                'variety', 'motion picture world', 'exhibitors herald', 'moving picture world',
                'photoplay', 'picture play', 'motion picture magazine', 'silver screen',
                'motion picture classic', 'screenland', 'variety radio'
            ],
            medium: [
                'film daily', 'motion picture news', 'wids', 'motion picture herald',
                'box office', 'independent exhibitor', 'harrison reports', 'film bulletin'
            ],
